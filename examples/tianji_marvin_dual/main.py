"""Inference entrypoint for dual TianjiMarvin AR arms with Zhixing grippers."""
...
from examples.tianji_marvin_dual import env as _env
...
def main(args: Args) -> None:
    ...
    environment = _env.DualTianjiMarvinEnvironment(
        reset_joint_positions=metadata.get("reset_pose"),
        render_height=args.render_height,
        render_width=args.render_width,
        robot_ip=args.robot_ip,
        tianji_sdk_python_dir=args.tianji_sdk_python_dir,
        tianji_kinematics_config_path=args.tianji_kinematics_config_path,
