"""OpenPI runtime adapter for dual Rokae AR arms with Zhixing grippers."""
...
from examples.rokae_zhixing_dual import real_env as _real_env


class DualRokaeZhixingEnvironment(_environment.Environment):
