...
_CONFIGS = [
    ...
    *polaris_config.get_polaris_configs(),
    ...
    # 5.marvin 双臂叠纸杯
    TrainConfig(
        name="pi05_marvin_dual_lora_finetune_stack_paper_cups_0707",
        model=pi0_config.Pi0Config(
            pi05=True,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        data=LeRobotRokaeDualDataConfig(
            repo_id="/data/vt_umi_dataset/converted_dataset/marvin_stack_paper_cups_0707",
            assets=AssetsConfig(
                asset_id="/data/vt_umi_dataset/converted_dataset/marvin_stack_paper_cups_0707/assets",
            ),
            default_prompt="Pick up the paper cups and stack them up",
            repack_transforms=_transforms.Group(
                inputs=[
    ...
    #
    TrainConfig(
        name="rlt_pi05_marvin_dual_lora_stack_paper_cups_0707",
        model=pi0_config.Pi0Config(
            pi05=True,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
    ...
    # 6.rokae 双臂叠纸杯_5个杯子
    TrainConfig(
        name="pi05_rokae_dual_lora_finetune_stack_paper_cups_0708",
        model=pi0_config.Pi0Config(
            pi05=True,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        data=LeRobotRokaeDualDataConfig(
            repo_id="/data/vt_umi_dataset/converted_dataset/rokae_stack_paper_cups_mixed_0708",
            assets=AssetsConfig(
                asset_id="/data/vt_umi_dataset/converted_dataset/rokae_stack_paper_cups_mixed_0708/assets",
            ),
            default_prompt="Pick up the paper cups and stack them up",
            repack_transforms=_transforms.Group(
                inputs=[
    ...
    #
    TrainConfig(
        name="rlt_pi05_rokae_dual_lora_stack_paper_cups_0708",
        model=pi0_config.Pi0Config(
            pi05=True,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
